...
;(function () {
  ...
  Darkroom.plugins['circle'] = Darkroom.Plugin.extend({
    ...
    addCircle: function (type) {
      ...
      this.darkroom.applyTransformation(new CicleRoom());
    }
  });
})();
;(function () {
  ...
  Darkroom.plugins['crop'] = Darkroom.Plugin.extend({
    ...
    onKeyDown: function (event) {
      if (false === this.options.quickCropKey || event.keyCode !== this.options.quickCropKey || this.isKeyCroping) return;
    ...
    toggleCrop: function () {
      if (!this.hasFocus()) this.requireFocus();else this.releaseFocus();
    },
    ...
    _renderCropZone: function (fromX, fromY, toX, toY) {
      ...
      if (rightX - leftX < minWidth) {
        if (isRight) rightX = leftX + minWidth;else leftX = rightX - minWidth;
      }
      if (bottomY - topY < minHeight) {
        if (isDown) bottomY = topY + minHeight;else topY = bottomY - minHeight;
      }
...
;(function () {
  ...
  Darkroom.plugins['txt'] = Darkroom.Plugin.extend({
    ...
    addTxt: function (content) {
      ...
      this.darkroom.applyTransformation(new TextRoom());
    }
  });
})();